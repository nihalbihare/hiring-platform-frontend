  ...
  return (
    <div className='flex items-center px-16'>
      <div className='flex flex-col w-[45%] gap-3'>
        ...
        <TextInput className='bg-mine-shaft-900 rounded-lg px-2 text-mine-shaft-100 [&_input]:text-mine-shaft-100 ' variant="unstyled" label="Job Title" placeholder="Software Engineer"
    />
     <TextInput className='bg-mine-shaft-900 rounded-lg px-2 text-mine-shaft-100 [&_input]:text-mine-shaft-100 ' variant="unstyled" label="Job Type" placeholder="Full Time"
    />
    <div className='flex items-center justify-center w-20 bg-bright-sun-400 text-mine-shaft-100 rounded-lg p-2 hover:bg-bright-sun-500 cursor-pointer '>
    <IconSearch stroke={1.25} className='h-[85%] w-[85%]' />
      ...
      <div className='w-[55%] flex items-center justify-center'>
        <div className='w-[30rem] relative'>
          ...
          <div className='absolute w-fit -right-10 top-[50%] border-bright-sun-400 border rounded-lg p-2 backdrop-blur-md'>
    ...
    <Avatar.Group>
      ...
      <Avatar>+3</Avatar>
          ...
          <div className='absolute w-fit -left-5 top-[28%] border-bright-sun-400 
