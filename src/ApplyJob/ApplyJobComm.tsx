      ...
      <div className='flex justify-between'>
            <div className='flex gap-2 items-center '>
                ...
                <div>
                    ...
                    <div className='text-lg text-mine-shaft-300 xs-mx:text-base'><span>{props.company} &bull;</span> 
                        <span>{timeAgo(props.postTime)} &bull;</span><span>  {props.applicants?props.applicants.length:0} Applicants</span></div>
                </div>
            </div>
